...
const DEFAULTS = {
  sources: {
    ...
    style: '暖米色纸感底, 细腻手绘线稿简笔插画, 中式工笔小景, 红色印章点缀, 日系清新可爱', elements: '花枝, 云纹, 小动物, 日月, 印章',
    mood: '温暖, 明亮, 喜悦, 治愈, 可爱', avoid: '照片写实, 任何四色（黑红黄白）以外的颜色, 蓝/青/绿/紫色天空与背景, 蓝紫渐变, 密集文字, 悬浮漂浮的无关物体, 农家院子/村庄/土墙/篱笆等乡土场景, 写实的人物特写, 图标拼贴, 元素罗列堆砌, 供桌/祭台式静物陈列, 祭祀供奉感, 抽象构成, 晦涩隐喻, 阴郁冷清, 孤独感, 暗色背景, 大面积黑色, 压抑深沉的氛围, 门牌号过小或位置不突出, 门牌号大小或位置不稳定, 单侧或单角出现大片空白, 画面底部出现横条/色块/两个格子, 门牌号与背景图案互相遮挡或重叠穿插'
  },
